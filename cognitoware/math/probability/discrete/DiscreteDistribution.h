...
#ifndef MATH_PROBABILITY_DISCRETE_DISCRETEDISTRIBUTION_H_
#define MATH_PROBABILITY_DISCRETE_DISCRETEDISTRIBUTION_H_
...
#endif /* MATH_PROBABILITY_DISCRETE_DISCRETEDISTRIBUTION_H_ */
