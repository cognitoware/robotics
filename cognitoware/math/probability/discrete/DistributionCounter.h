...
#ifndef MATH_PROBABILITY_DISCRETE_DISTRIBUTIONCOUNTER_H_
#define MATH_PROBABILITY_DISCRETE_DISTRIBUTIONCOUNTER_H_
...
#endif /* MATH_PROBABILITY_DISCRETE_DISTRIBUTIONCOUNTER_H_ */
